...
if lookup_res == ngx.null then                
    ...
    if host == nil then
        ...
        ngx.say([[<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No pods are currently available. Starting a new one for your session. Please retry in a bit.</h1><img src="images/loading.jpg" alt="Take a cup of coffea" />]])
        return
    end
