        ...
        for key in keys:
            ...
            if current_time - last_access >= time_interval:
                try:
                    ...
                    while loop < 3:
                        ...
                        if MESSAGE in data.decode('utf-8'):
                            print("successfully closed runtime on {}:{}!".format(UDP_IP, UDP_PORT))
                            k += 1
                            sock.close()
                            break
                        else:
                ...
                try:
                    ...
                    print(e)
                    print("failed to clear cache key {}!".format(key))
                    return "failed to clear cache key {}!".format(key)

    return "successfully cleaned up {} idle runtimes!".format(k)
